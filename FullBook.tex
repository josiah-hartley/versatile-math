...
\input{financial-math/PercentsAndApplications2.tex}

\section{Income Tax}
\input{financial-math/IncomeTax2.tex}

\section{Simple and Compound Interest}
\input{financial-math/SimpleAndCompoundInterest2.tex}

\section{Annuities}
\input{financial-math/Annuities2.tex}

\section{Installment Loans and Credit Cards}
\input{financial-math/InstallmentLoansAndCreditCards2.tex}
...
\input{growth-models/LinearGrowth2.tex}

\section{Exponential Models}
\input{growth-models/ExponentialGrowth2.tex}

\section{Logistic Models}
\input{growth-models/LogisticGrowth2.tex}
...
\input{statistics/SamplingAndGraphs2.tex}

\section{Measures of Center}
\input{statistics/MeasuresOfCenter2.tex}

\section{Measures of Spread}
\input{statistics/MeasuresOfSpread2.tex}

\section{The Normal Distribution}
\input{statistics/NormalDistribution2.tex}
...
\input{probability/BasicConcepts2.tex}

\section{The Addition Rule and the Rule of Complements}
\input{probability/Additionrule2}

\section{The Multiplication Rule and Conditional Probability}
\input{probability/Multiplicationrule2}

\section{Counting Methods}
\input{probability/Counting2}
...
\input{linear-programming/LinearGraphs2.tex}

\section{Systems of Linear Equations}
\input{linear-programming/SystemsOfEquations2.tex}

\section{Systems of Linear Inequalities}
\input{linear-programming/SystemsOfInequalities2.tex}

\section{Linear Programming}
\input{linear-programming/LinearProgrammingSection2.tex}
...
\input{logic/StatementsOperations.tex}

\section{Conditionals and Equivalence}
\input{logic/ConditionalsEquivalence.tex}

\section{Logic Rules}
\input{logic/LogicRules.tex}

\section{Arguments}
\input{logic/Arguments.tex}
...
\input{set-theory/SetConcepts.tex}

\section{Set Operations}
\input{set-theory/SetOperations.tex}

\section{Properties of Set Operations}
\input{set-theory/SetProperties.tex}

\section{Survey Problems}
\input{set-theory/SurveyProblems.tex}
